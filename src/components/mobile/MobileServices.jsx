...
const services = [
    {
        ...
        image: "/assets/mobile_website_inetractivity.webp",
        color: "#d4af37"
    },
    {
        id: 1,
    ...
    },
    {
        ...
        image: "/assets/mobile_service_pixel.webp",
        color: "#ffffff"
    },
    {
        id: 4,
    ...
    return (
        <div className="relative w-full h-full bg-[#050505] overflow-hidden">
            ...
            <div className="absolute inset-0 z-40 pointer-events-none">
                ...
                {/* Right Button */}
                <div
                    className={`absolute right-4 top-[58%] -translate-y-1/2 pointer-events-auto transition-opacity duration-300 ${index < services.length - 1 ? 'opacity-100' : 'opacity-0'}`}
                    onClick={() => index < services.length - 1 && setIndex(index + 1)}
                >
                    <div className="w-10 h-10 rounded-full bg-black/40 backdrop-blur-md flex items-center justify-center border border-white/20 active:scale-95 transition-transform">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2">
